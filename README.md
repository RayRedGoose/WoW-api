...
| `/api/v1/races/:id/classes` | POST | `{classes: <Array of Numbers>}` | Array of added race-class pairs: `[{ race_id: 1, class_id: 2 }, { race_id: 1, class_id: 12}]` |
...
| url | verb | options | sample response |
| ----|------|---------|---------------- |
| `/api/v1/races/:id` | DELETE | not needed | Object with result: `{ result: 'Success!' }` |
| `/api/v1/races/:id/classes` | DELETE | not needed | Object with result: `{ result: 'Success!' }` |
| `/api/v1/characters/:id` | DELETE | not needed | Object with result: `{ result: 'Success!' }` |
